...
function Home() {
  return (
    <>
      ...
      <h1 style={{display:"flex",justifyContent:"center",fontSize:50}} >Testimonials</h1>
      <p style={{display:"flex",justifyContent:"center",fontSize:30,padding:30}} >Some amazing Experience from Techie Around.</p>
        ...
        <div className="home-card-container">
            ...
            >
              ...
              <img style={{display:"flex",marginLeft:85}} id="img-home" src = "/images/profile.png"></img>
                ...
                <img style={{display:"flex",marginLeft:50}} id="img-rating" src = "/images/rating.png"></img>
